...
2. **Install dependencies:**
   ...
   _Note: If you encounter peer dependency issues with Styled Components, use `npm install --legacy-peer-deps`._
...
4. **Run tests:**
   ...
   _Tests cover the data parser logic and currency calculations._
